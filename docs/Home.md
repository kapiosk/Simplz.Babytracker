# Baby Tracker — user manual

A tracker for a newborn, running on a machine you own. It records feeds, sleep, nappies and
spit-ups, keeps photos against an entry, and turns all of it into a chart and a report you can
show a doctor.
...
- **[Passwords and access](Passwords-and-access)** — the two passwords and the read-only role
- **[Installing it on a phone](Installing-on-a-phone)** — add to home screen
- **[When something goes wrong](When-something-goes-wrong)** — the Reload button and what it fixes

Setting it up on a server is in the [README](https://github.com/kapiosk/Simplz.Babytracker), not
here. This manual is for using it.
